...
import (
	...
	"github.com/erkentus/erebus/models"
)

/*GetOK list the running tasks
...
func (o *GetOK) WithPayload(payload []*models.Task) *GetOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get o k response
func (o *GetOK) SetPayload(payload []*models.Task) {
	o.Payload = payload
}
